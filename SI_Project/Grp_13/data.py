...
# Load the model
model = pickle.load(open(r"C:/Parkinsons 2ND SEM THIRD YEAR/SI_Project/BACKUp/model.pkl", "rb"))
...
def main():
    ...
    features['spread1'] = st.number_input('Spread1 : Measure of vocal fold oscillation.', min_value=-10.0)
